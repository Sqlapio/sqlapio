...
return [
    ...
    'form' => [
        ...
        'horas'                    => 'Every / Hours',
        'ciclo_menstrual'          => 'Cycle length',
        'infecciones'              => 'Previous Infections',
        'exam_previos'             => 'Previous gynecological exams',
        'MENOSPA_fecha_ini'        => 'Start Age',
        'MENOSPA_sintomas'         => 'Symptoms',
        'MENOSPA_tratamiento'      => 'Treatment',
        'ACTSEX_activo'            => 'Sexually Active?',
        'ACTSEX_enfermedades_ts'   => 'Sexually transmitted diseases, which one?',
        'IMC19_covid'              => 'COVID',
        'IMC19_dosis'              => 'Dose',
        'IMC19_fecha_ultima_dosis' => 'Date last dose',
        'IMC19_marca'              => 'Brand',
    ...
    'acordion' => [
        ...
        'antecedentes_salud'      => 'Mental health',
        'inmunizaciones'          => 'Immunizations (Vaccines)',
    ...
    'subtitulos' => [
        ...
        'ginecologicos'         => 'Gynecological History',
        'obstetricos'           => 'Obstetric History',
        'menopausia'            => 'History of Menopause',
        'act_sexual'            => 'Sexual activity background',
    ],
    ...
    'label' => [
        ...
        'datos_seguro'        => 'Insurance data',
        'compañia'            => 'Company',
        'vigencia'            => 'Validity',
        'num_contacto'        => 'No. contact',
        'am'                  => 'AM',
        'pm'                  => 'PM',
        'detalle_plan'        => 'Plan Details',
        'centro_salud'        => 'Health Center',
    ...
    'graficas' => [
        ...
        'noviembre'             => 'November',
        'diciembre'             => 'December',
        'citas_atendidas_mes'   => 'Appointments Attended',
        'citas_canceladas_mes'  => 'Appointments Canceled',
        'citas_confirmadas_mes' => 'Appointments Confirmed',
        'citas_sinconfirmar_mes'=> 'Appointments Scheduled',
        'citas_noatendidas_mes' => 'Appointments Not Attended',
        'canceladas'            => 'Cancelled',
        'confirmadas'           => 'Confirmed',
        'sin_confirmar'         => 'Scheduled',
        'atendidas'             => 'Attended',
        'total'                 => 'Total',
        'citas'                 => 'Total Quotes',
        'citas_general2'        => 'Appointments per month: Scheduled / Confirmed',
        'citas_general'         => 'Appointments per month: Scheduled / Attended',
        'citas_general3'        => 'Appointments per month: Scheduled / Cancelled',
        'citas_general4'        => 'Appointments per month: Scheduled / Not Attended',
        'consultas_historias'   => 'Total Queries / Stories',
        'pacientes_tipo'        => 'Number of Patients by Age',
        'pacientes_tipo_sex'    => 'Number of Patients by Gender',
        'citas_registradas'     => 'Scheduled Appointments',
