    ...
    <div class="row mt-2" style='align-items: flex-end;'>
        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-4">
            <div class="form-group">
                ...
                <input maxlength="15" type="text" class="form-control mask-alfa-numeric" id="search_person" name="search_person"  placeholder="@lang('messages.placeholder.buscar_paciente')" value="">
            </div>
        </div>
