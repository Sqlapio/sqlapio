...
@push('scripts')
    <script>
        ...
        const handlerInmunizations = (e) => {
            ...
            if(e.target.id == 'IMC19_covid' && $(`#${'IMC19_covid'}`).is(':checked') == true) {
                $('#covid_input').show();

            } else if($(`#${'IMC19_covid'}`).is(':checked') == false) {
                $('#covid_input').hide();
                $('#covid_input').val('');
            }
                                    ...
                                    {{-- inmunizaciones --}}
                                        ...
                                        <div class="row" id="div_inmunizations">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 col-xxl-10 mt-2" id="covid_input" style="{!! !empty($validateHistory->IMC19_covid) ? '' : 'display: none' !!}">
                                                    <div class="d-flex">
                                                        <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mt-2" style="margin-right: 10px">
                                                            <div class="form-group">
                                                                <div class="Icon-inside">
                                                        ...
                                                        <div class="col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mt-2" style="margin-right: 10px">
                                                            <div class="form-group">
                                                                <div class="Icon-inside">
