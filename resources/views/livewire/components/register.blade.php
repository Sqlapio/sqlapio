...
@push('scripts')
    <script>
        ...
        async function handlerSelect2(data) {

            $("#form-register").trigger("reset");
            $("#div-new-center").hide();
            $("#id_center").val(data.id);
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-10 col-md-5 col-lg-5 col-xl-5 col-xxl-5">
                                        ...
                                        <div class="form-group">
                                            <div class="Icon-inside">
                                                ...
                                                <input autocomplete="off" class="form-control mask-text" id="name"
                                                    ...
                                                    placeholder="@lang('messages.form.nombre')">
                                        ...
                                        <div class="form-group">
                                            <div class="Icon-inside">
                                                ...
                                                <input autocomplete="off" class="form-control mask-text" id="last_name"
                                                    ...
                                                    placeholder="@lang('messages.form.apellido')">
                                                <i class="bi bi-person-circle"></i>
                                            </div>
                                        </diV>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="Icon-inside">
                                                ...
                                                <input autocomplete="off" class="form-control mask-only-number"
                                                    ...
                                                    placeholder="@lang('messages.label.documento_identidad')">
                                                <i class="bi bi-person-circle"></i>
                                            </div>
                                        </diV>
                                    </div>
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-3"
                                        style="display: none" id="div_business_name">
                                        <div class="form-group">
                                            <div class="Icon-inside">
                                                ...
                                                <input autocomplete="off" placeholder="" class="form-control mask-text"
                                                    ...
                                                    placeholder="@lang('messages.form.razon_social')">
                                        ...
                                        <div class="form-group">
                                            <div class="Icon-inside">
                                                ...
                                                <input autocomplete="off" class="form-control" id="password"
                                                    ...
                                                    placeholder="@lang('messages.form.contraseña')">
                                        ...
                                        <div class="form-group">
                                            <div class="Icon-inside">
                                                ...
                                                <input autocomplete="off" class="form-control" id="password_confrimation"
                                                    ...
                                                    placeholder="@lang('messages.form.confirmar_contraseña')">
                                        ...
                                        <div class="form-group">
                                            <div class="Icon-inside">
                                                ...
                                                <input autocomplete="off" class="form-control" id="email"
                                                    ...
                                                    placeholder="@lang('messages.form.email')">
                                                <i class="bi bi-envelope"></i>
                                            </div>
                                        </diV>
                                    </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-4 mb-3"
                                    style="display: flex; justify-content: space-around;">
                                    <div
                                        class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 d-flex justify-content-center">
                                        <input class="btn btnPrimary" value="@lang('messages.botton.registrar')"
