    ...
    <div>
        <div class="container-fluid">
            <div class="row mt-3">
                ...
                <div class="col-sm-10 md-10 lg-10 xl-10 xxl-10 mt-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-3 md-3 lg-3 xl-3 xxl-3 mt-2">
                        ...
                        <div class="card-header">
                            <div class="col-sm-3 md-3 lg-3 xl-3 xxl-3 mt-3">
                    ...
                    <div id="result-table" style="display: none" class="col-sm-12 md-12 lg-12 xl-12 xxl-12 mt-2">
                        <div class="card">
                            <div class="card-header collapseBtn">
                                <i class="bi bi-list-task"></i>
                    ...
                    <div id="result-grafica" style="display: none" class="col-sm-12 md-12 lg-12 xl-12 xxl-12 mt-2">
                        <div class="card">
                            <div class="card-header collapseBtn">
                                <i class="bi bi-list-task"></i>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div id="grafica" class="col-sm-12 md-12 lg-12 xl-12 xxl-12 mt-3">
                                        <x-graphic-result />
                    ...
                    <div id="result-grafica-fac" style="display: none" class="col-sm-12 md-12 lg-12 xl-12 xxl-12 mt-2">
                        <div class="card">
                            <div class="card-header collapseBtn">
                                <i class="bi bi-list-task"></i>
