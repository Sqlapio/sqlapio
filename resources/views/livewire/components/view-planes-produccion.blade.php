<div>
    ...
    <script>
        ...
        function opcion_plan(action, type_plan) {
            $('#ModalOpcionsPlanes').modal('show');
        }
    ...
    <div class="row" style="padding: 20px;">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-3 mb-3 btn-plans" style="display: flex;">
            <button type="button" onclick="opcion_plan(1,{{ Auth::user()->type_plane }})" class="btn btnPrimary" id="renew-btn">@lang('messages.botton.renovar')</button>
            <button type="button" onclick="renew_plan()" class="btn btnSecond" id="change-btn" style="margin-left: 20px">@lang('messages.botton.cambiar_plan')</button>
        </div>
        <hr style="margin-top: 5px">
    ...
    <!-- Modal para opciones del plan-->
    <div class="modal fade" id="ModalOpcionsPlanes" tabindex="-1" aria-labelledby="ModalRenewPlanesLabel" aria-hidden="true" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-2 mb-3" style="display: flex; justify-content: center;">
                                                    ...
                                                    @if (auth()->user()->subscribedToPrice('price_1P0pQHLoqeBM9Dte329KfBtS', 'Plan Profesional'))
                                                        @if (auth()->user()->subscribedToPrice('price_1P0pQHLoqeBM9Dte329KfBtS', 'Plan Profesional'))
                                                            <button class="btn btnSave" wire:click="$emit('cancel_Subscription', 'price_1P0pQHLoqeBM9Dte329KfBtS')" style="min-width: 70px; margin-top: 10px">
                                                                @lang('messages.botton.cancelar_plan')
                                                            </button>
                                                            <button class="btn btnSave" wire:click="$emit('new_Subscription', 'price_1P0pWxLoqeBM9DteJSDhjowR')" style="min-width: 70px; margin-top: 10px; margin-left: 10px"> @lang('messages.botton.suscribirse_anual')</button>
                                                        @else
                                                    ...
                                                    @if (auth()->user()->subscribedToPrice('price_1P0pWxLoqeBM9DteJSDhjowR', 'Plan Profesional'))
                                                        @if (auth()->user()->subscribedToPrice('price_1P0pWxLoqeBM9DteJSDhjowR', 'Plan Profesional'))
                                                            <button class="btn btnSave" wire:click="$emit('cancel_Subscription', 'price_1P0pWxLoqeBM9DteJSDhjowR')" style="min-width: 70px; margin-top: 10px">
                                                                @lang('messages.botton.cancelar_plan')
                                                            </button>
                                                        @else
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-2 mb-3" style="display: flex; justify-content: center;">
                                                    ...
                                                    @if (auth()->user()->subscribedToPrice('price_1OyKMhLoqeBM9DteVmOZwlrz', 'Plan Ilimitado'))
                                                        @if (auth()->user()->subscribedToPrice('price_1OyKMhLoqeBM9DteVmOZwlrz', 'Plan Ilimitado'))
                                                            <button class="btn btnSave" wire:click="$emit('cancel_Subscription', 'price_1OyKMhLoqeBM9DteVmOZwlrz')" style="min-width: 70px; margin-top: 10px">
                                                                @lang('messages.botton.cancelar_plan')
                                                            </button>
                                                    ...
                                                    @if (auth()->user()->subscribedToPrice('price_1OyKN3LoqeBM9DtewtoXlP0H', 'Plan Ilimitado'))
                                                        @if (auth()->user()->subscribedToPrice('price_1OyKN3LoqeBM9DtewtoXlP0H', 'Plan Ilimitado'))
                                                            <button class="btn btnSave" wire:click="$emit('cancel_Subscription', 'price_1OyKN3LoqeBM9DtewtoXlP0H')" style="min-width: 70px; margin-top: 10px">
                                                                @lang('messages.botton.cancelar_plan')
                                                            </button>
                                                        @else
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-3">
                                            ...
                                            <div id="profesional" style="display: none">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-2 mb-3" style="display: flex; justify-content: center;">
                                                        {{-- mensual - 19,99 --}}
                                                            <button class="btn btnSave"  wire:click="$emit('new_Subscription', 'price_1P0pQHLoqeBM9Dte329KfBtS')" style="min-width: 70px; margin-top: 10px"> @lang('messages.botton.suscribirse_mensual')</button>
                                                        {{-- anual - 199,99 --}}
                                                            <button class="btn btnSave"  wire:click="$emit('new_Subscription', 'price_1P0pWxLoqeBM9DteJSDhjowR')" style="min-width: 70px; margin-top: 10px"> @lang('messages.botton.suscribirse_anual')</button>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- ilimitado --}}
                                            <div id="ilimitado" style="display: none">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-2 mb-3" style="display: flex; justify-content: center;">
                                                        {{-- mensual - 39,99$ --}}
                                                            <button class="btn btnSave"  wire:click="$emit('new_Subscription', 'price_1OyKMhLoqeBM9DteVmOZwlrz')" style="min-width: 70px; margin-top: 10px"> @lang('messages.botton.suscribirse_mensual') </button>
                                                        {{-- anual - 399.99$ --}}
                                                            <button class="btn btnSave"  wire:click="$emit('new_Subscription', 'price_1OyKN3LoqeBM9DtewtoXlP0H')" style="min-width: 70px; margin-top: 10px"> @lang('messages.botton.suscribirse_anual') </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@push('js')
    <script>
        ...
        Livewire.on('cancel_Subscription', priceId => {
            Swal.fire({
                title: '@lang('messages.alert.cancelar')',
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: '#42ABE2',
                cancelButtonColor: '#d33',
