                ...
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3 mt-3"
                    ...
                    <div class="card-wrap">
                        <div class="card-header one">
                            <img width="80" height="auto" src="{{ asset('/img/icons/patients.png') }}"
                                alt="avatar">
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-3">
                                            <div id="profesional" style="display: none">
                                                    ...
                                                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8 mt-2 mb-3" style="display: flex; justify-content: center;">
                                                        ...
                                                        {{-- Suscrito --}}
                                                            @if (auth()->user()->subscription('Plan Ilimitado')->onGracePeriod())
                                                                <button class="btn btnSave" wire:click="resumeSubcription" wire:target="resumeSubcription" style="min-width: 70px; margin-top: 10px">
                                                                    Reanudar
                                                                </button>
                                                            @else
                                                ...
                                                <div id="spinner" wire:target="newSubscription('price_1OvmISLoqeBM9DteyJr9GA34')" wire:loading >
                                                    <x-load-spinner />
                                                </div>
                                            </diV>
                                            <div id="ilimitado" style="display: none">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8 mt-2 mb-3" style="display: flex; justify-content: center;">
                                                        <input class="btn btnSave send " value="ilimitado" type="submit" style="margin-left: 20px" />
                                                    </div>
                                                </div>
                                            </diV>
                                        </div>
