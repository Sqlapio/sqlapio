                ...
                <div class="row-data">
                    <div style="margin-top: 30px">
                        ...
                        @foreach ($data_exam as $item)
                            <pre
                                style="font-size: 17px ; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">{{ $item->description }}</pre>
                        @endforeach
                    </div>
                </div>
            </div>
