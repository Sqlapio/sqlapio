            ...
            <div class="" style="margin-top: 16%;">
                ...
                <div class="row-data">
                    <div style="margin-top: 30px">
                        <pre style="font-size: 12px ; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">{{ $MedicalRecord->description }}</pre>
                    </div>
                </div>
            </div>
        </div>
